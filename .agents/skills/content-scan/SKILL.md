...
- **This is a triage tool, not a drafting tool.** It identifies what to write about. Drafting is done directly by an agent against the terminology doc, then reviewed via `/edit-log` or `/edit-article`.
