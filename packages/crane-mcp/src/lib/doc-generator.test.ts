...
describe('doc-generator', () => {
  ...
  describe('generateDoc', () => {
    ...
    it('generates project-instructions from CLAUDE.md', async () => {
      ...
      vi.mocked(readFileSync).mockReturnValue('# CLAUDE.md\n\nThis is the crane console project.\n\n## Stack\nTypeScript, Cloudflare Workers');
    ...
    it('generates api doc from route files', async () => {
      ...
      vi.mocked(readFileSync).mockReturnValue('export function GET() { return new Response("ok"); }');
    ...
    it('generates schema doc from migrations', async () => {
      ...
      vi.mocked(readFileSync).mockReturnValue('CREATE TABLE users (id INTEGER PRIMARY KEY, name TEXT);');
